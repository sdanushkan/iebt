...
from .models import Faculty, Course, Level, QualificationApproval, OurQualification, Unit, Country, Contact, FAQ, About, AbroadApplication, CourseRequirment
...
@admin_thumbnails.thumbnail('quation', 'answer')
