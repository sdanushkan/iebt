                            ...
                            <div className='flex flex-col gap-6 px-6 lg:px-0'>
                                ...
                                <div className='flex flex-col sm:flex-row flex-wrap justify-between gap-4 '>
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-sm lg:text-xs font-medium capitalize'>{course.programe.name}</p>
                                    </div>
                                    <div className='flex flex-col'>
                            ...
                            <div className='flex flex-col gap-4 bg-white px-8 py-8 rounded-[8px] border-[1px] border-[#DA0C0C] border-opacity-25'>
                                ...
                                <div className=' bg-[#DA0C0C] relative'>
                                    ...
                                    </Skeleton>
                                    {
                                        ...
                                        <img src={course.gif_logo} alt='' className='h-[50px] w-full object-cover absolute top-0'/>
                                    }
                                </div>
                                <div className='max-w-full'>
                                    ...
                                    >
                                        ...
                                        <SwiperSlide>
                                            ...
                                            <p className='text-xl font-semibold text-white '>{course.s_top}</p>
                                            {/* <p className='text-6xl font-bold text-white mx-auto'>56%</p> */}
                                            <p className='text-4xl font-bold text-white mx-auto'>{course.s_center}</p>
                                            {/* <p className='text-xl font-semibold text-white ml-auto'>Scholarship</p> */}
                                            <p className='text-xl font-semibold text-white ml-auto'>{course.s_bottom}</p>
                                        </div>
                                        </SwiperSlide>
                                    </Swiper>
