      ...
      <div className='h-fit w-full max-w-[1200px] flex gap-4 mx-auto md:px-6 pt-4'>
        ...
        <div className={
          ...
          <div className='h-screen md:h-fit w-full bg-white px-4 md:px-0 py-6 md:py-0 divide-y-1 flex flex-col gap-4'>
            ...
            {
              nFaculty?
              <Accordion defaultExpandedKeys={[`${nFaculty?nFaculty:''}`]}  onSelect={nFaculty} onSelectionChange={setNFaculty} isCompact className='w-full min-w-full md:w-[300px] md:min-w-[300px]'>
              {
                facultyListLoading?
                "":
                faculties && nFaculty?
        ...
        <div className='h-fit w-full flex flex-col gap-6 relative z-10'>
            {
              nFaculty?
              <p className='text-lg font-semibold'>All {nFaculty} Courses</p>:
              ''
            }
